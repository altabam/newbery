...
from configuracion.models import Personas, Disciplinas, Categorias, JugadoresCategoria
...
def listadoDisciplinas(request):
    ...
    contexto =[
        { "listadoDisciplinas": listadoDisciplina }
    ]
...
def listadoCategorias(request):
    ...
    contexto =[
        { "listadoDisciplinas": listadoCategoria }
    ]
